...
import { createClassScheduleService, deleteClassScheduleService, getByIdClassScheduleService, getClassScheduleService, updateClassScheduleService } from '@/services/class.schedule.service';
...
export const createClassScheduleController = async (
  ...
  try {
    ...
    const classSchedule = await createClassScheduleService(className, trainer, new Date(day), maxTrainees);
...
export const updateClassScheduleController = async (
  ...
  try {
    ...
    const { className, trainer, day, maxTrainees } = req.body;
    const updatedClassSchedule = await updateClassScheduleService(id, className, trainer, new Date(day), maxTrainees);
...
export const getClassSchedulesController = async (
  ...
  try {
    ...
    const { bookings, pagination } = await getClassScheduleService(pageNumber, pageSize);
